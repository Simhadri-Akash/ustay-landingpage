...
import { ArrowUpRight, Check, MapPin, Phone, Mail, Laptop, Shirt, Wind, Wifi, Bath, Tv, ChevronsUpDown, ShieldCheck, ConciergeBell, Car, Users, Clock, Utensils } from 'lucide-react';
...
const facilityTiles:FacilityTile[]=[
 ...
 {title:'Common area',copy:'A shared common space with seating.',src:'/assets/common-area.jpg',className:'tile-c'},
 {title:'Terrace & open space',copy:'An open-air terrace, above the everyday.',src:'/assets/terrace-poster.webp',className:'tile-d'},
 {title:'The building',copy:'The Ustay exterior, Madhapur.',src:'/assets/exterior.jpeg',className:'tile-e'},
];
